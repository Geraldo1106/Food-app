        ...
        return Column(children: [
          ...
          Expanded(child: SingleChildScrollView(
            ...
            child: Column(children: [
              ...
              _restaurant.selfDeliverySystem == 1 ? MyTextField(
              ...
              Get.find<SplashController>().configModel!.scheduleOrder! ? SwitchButton(icon: Icons.alarm_add, title: 'schedule_order'.tr, isButtonActive: widget.restaurant.scheduleOrder, onTap: () {
                if(_restaurant.instanceOrder!) {
                  _restaurant.scheduleOrder = !_restaurant.scheduleOrder!;
                } else {
                showCustomSnackBar('can_not_disable_both_instance_order_and_schedule_order'.tr);
                }
              }) : const SizedBox(),
              ...
              SwitchButton(icon: Icons.fastfood_outlined, title: 'instance_order'.tr, isButtonActive: widget.restaurant.instanceOrder, onTap: () {
                if(_restaurant.scheduleOrder!) {
                  _restaurant.instanceOrder = !_restaurant.instanceOrder!;
                } else {
                  showCustomSnackBar('can_not_disable_both_instance_order_and_schedule_order'.tr);
                  _restaurant.instanceOrder = _restaurant.instanceOrder!;
                }
