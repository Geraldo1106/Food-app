...
class TransactionStatusCard extends StatelessWidget {
  ...
  const TransactionStatusCard({Key? key, this.isCompleted = false, this.isOnHold = false, required this.amount, this.completedToolTip, this.onHoldToolTip, this.canceledToolTip }) : super(key: key);
            ...
            children: [
              Stack(
                children: [
                  ...
                  Positioned(
                    right: 10, top: 10,
                    child: Image.asset(isOnHold ? Images.onHoldTransactionIcon : isCompleted ? Images.completeTransactionIcon
                        : Images.cancelTransactionIcon, height: 15, width: 15),
                  ),
                ],
              ),
