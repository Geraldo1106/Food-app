...
class MenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<MenuModel> menuList = [
      ...
      MenuModel(icon: Images.reportsIcon, title: 'reports'.tr, backgroundColor: const Color(0xFFFF8A80), route: RouteHelper.getReportsRoute()),

      if(Get.find<SplashController>().configModel!.disbursementType == 'automated')
      MenuModel(icon: Images.disbursementIcon, title: 'disbursement'.tr, backgroundColor: const Color(0xFF62889C), route: RouteHelper.getDisbursementMenuRoute()),
